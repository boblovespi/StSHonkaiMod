...
import boblovespihonkaimod.battlesuits.AbstractBattlesuit;
import boblovespihonkaimod.cards.AbstractDefaultCard;
import boblovespihonkaimod.cards.attacks.NekoStomp;
import boblovespihonkaimod.characters.TheDefault;
import boblovespihonkaimod.events.IdentityCrisisEvent;
import boblovespihonkaimod.potions.PlaceholderPotion;
...
import static boblovespihonkaimod.characters.TheDefault.Enums.COLOR_GRAY;
...
public class DefaultMod implements
    ...
    private static final String AUTHOR = "boblovespi"; // And pretty soon - You!
    ...
    private static final String ATTACK_DEFAULT_GRAY = "boblovespihonkaimodResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "boblovespihonkaimodResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "boblovespihonkaimodResources/images/512/bg_power_default_gray.png";

    private static final String ENERGY_ORB_DEFAULT_GRAY = "boblovespihonkaimodResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "boblovespihonkaimodResources/images/512/card_small_orb.png";

    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "boblovespihonkaimodResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "boblovespihonkaimodResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "boblovespihonkaimodResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "boblovespihonkaimodResources/images/1024/card_default_gray_orb.png";

    // Character assets
    private static final String THE_DEFAULT_BUTTON = "boblovespihonkaimodResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "boblovespihonkaimodResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "boblovespihonkaimodResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "boblovespihonkaimodResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "boblovespihonkaimodResources/images/char/defaultCharacter/corpse.png";

    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "boblovespihonkaimodResources/images/Badge.png";

    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "boblovespihonkaimodResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "boblovespihonkaimodResources/images/char/defaultCharacter/skeleton.json";
    ...
    public DefaultMod() {
      ...
      */
        ...
        setModID("boblovespihonkaimod");
        // cool
        // TODO: NOW READ THIS!!!!!!!!!!!!!!!:

        // 1. Go to your resources folder in the project panel, and refactor> rename boblovespihonkaimod to
        // yourModIDResources.
        ...
        BaseMod.addColor(COLOR_GRAY, DEFAULT_GRAY, DEFAULT_GRAY, DEFAULT_GRAY,
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new PlaceholderRelic(), COLOR_GRAY);
        BaseMod.addRelicToCustomPool(new BottledPlaceholderRelic(), COLOR_GRAY);
        BaseMod.addRelicToCustomPool(new DefaultClickableRelic(), COLOR_GRAY);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("boblovespihonkaimod") // ${project.artifactId}
    ...
    public void receiveEditStrings() {
        ...
        BaseMod.loadCustomStringsFile(StanceStrings.class, getModID() + "Resources/localization/eng/DefaultMod-Stance-Strings.json");
    ...
    {
        if (AbstractDungeon.player.stance instanceof AbstractBattlesuit)
            ((AbstractBattlesuit) AbstractDungeon.player.stance).onExitOrVictory();
    }
}
